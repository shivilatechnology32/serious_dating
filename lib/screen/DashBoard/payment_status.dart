...
class _PaymentStatusState extends State<PaymentStatus> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        // group61MQz (187:6)
        margin: EdgeInsets.only(top: UiHelper.getSize(context).width / 5),
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // autogroup6uvyNaz (QtQTU4DD619KfJccx76uVY)
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: const Color(0xffff3838), width: 4),
                      color: const Color(0xffffffff),
                    ),
                    child: FittedBox(
                      child: Center(
            ...
            Container(
              // autogroupcylzVZ8 (QtQTMotcob18ALieiJCyLz)
